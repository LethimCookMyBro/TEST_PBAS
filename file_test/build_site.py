...
summaries["mock"] += '<li style="margin-bottom:15px"><div style="margin:10px 0"><img src="images/computer_network_ch10_new/page_12.png" style="max-height:150px; border-radius:4px" alt="acl mask"></div><b>(คำนวณ 1 ข้อ) 若ต้องการกำหนดช่วง Network 10.10.10.0/24 ในคำสั่ง ACL จะต้องเว้นวรรคและตามด้วย Wildcard Mask ค่าเลขใด?</b><br><span style="color:var(--yw)">ตอบ:</span> <code class="hl">0.0.0.255</code> (กลับหัวขั้วตรงข้ามกับ Subnet Mask 255.255.255.0)</li>'
